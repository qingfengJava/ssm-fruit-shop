...
<div class="panel admin-panel">
    <form action="item/findBySql" id="listform" method="post">
    <div class="padding border-bottom">
        <ul class="search" style="padding-left: 10px;">
            <li>
                <a class="button border-main icon-plus-square-o" href="item/add">添加商品</a>
            </li>
            <li>
    ...
    <table class="table table-hover text-center">
        ...
        <c:forEach items="${pagers.datas}" var="data" varStatus="1">
            <tr>
                <td>${data.name}</td>
                <td><img src="${data.url1}" alt="主图" style="width: 100px; height: 100px;"></td>
                <td>${data.price}</td>
                ...
                <td>
                    ...
                    <a class="button border-red" href="item/delete?id=${data.id}"><span class="icon-trash-o">下架</span></a>
                </td>
            </tr>
        </c:forEach>
        <tr>
            <td colspan="8">
                <div class="pagelist">
                    <!-- 分页开始 -->
                    <pg:pager url="item/findBySql" maxIndexPages="5" items="${pagers.total}" maxPageItems="15" export="curPage=pageNumber">
                        <pg:last>
