...
<div class="width1198 center_yh" style="height: 420px">
    <div class="left_yh" style="width: 350px; height: 420px;">
        ...
        <div id="preview">
            ...
            <div id="spec-list" style="margin-top: 5px">
                <ul class="list-h">
                    <li><img src="${obj.url2}" alt="" height="80" width="80" /></li>&nbsp;&nbsp;
                    <li><img src="${obj.url3}" alt="" height="80" width="80" /></li>&nbsp;&nbsp;
                    <li><img src="${obj.url4}" alt="" height="80" width="80" /></li>&nbsp;&nbsp;
                    <li><img src="${obj.url5}" alt="" height="80" width="80" /></li>&nbsp;&nbsp;
                </ul>
            </div>
        </div>
    </div>
    <div class="left_yh" style="width: 486px; height: 420px; margin-left: 42px">
        ...
        <div class="buyFor">
            <a href="/sc/exAdd?itemId=${obj.id}" class="mstBuy">收藏</a>
...
<div class="width1200 hidden_yh center_yh" style="margin-top: 40px">
    <div class="right_yh" style="width: 1200px;">
        ...
        <div class="width100 hidden_yh">
            ...
            <div id="spPj">
                <div class="width100 hidden_yh" style="padding-bottom: 20px; border-bottom: 1px dashed #DDDDDD; margin-bottom: 10px;">
                    <c:forEach items="${obj.pls}" var="data" varStatus="1">
                        <div style="width: 790px;float: right; overflow: hidden; margin-top: 20px;">
                            <img src="/resource/user/images/x.jpg" style="width: 40px;height: 40px; border-radius: 50%; float: left; border: 1px solid #DDDDDD; margin-top: 20px;" />
...
<script type="text/javascript">
    ...
    $(function (){
        $(".addCar").click(function (){
            ...
            $.ajax({
                type: "POST",
                url: "/car/exAdd?itemId=" + id + "&num="+num,
