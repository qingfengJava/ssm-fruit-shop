...
<div class="panel admin-panel">
    <div class="padding border-bottom">
        <ul class="search" style="padding-left: 10px;">
            <li>
                <a class="button border-main icon-plus-square-o" href="itemCategory/add2?pid=${obj.pid}">新增二级类目</a>
            ...
            <tr>
                ...
                <td>
                    <div class="button-group">
                        <a class="button border-main" href="itemCategory/update2?id=${data.id}">
                            <span class="icon-edit">修改</span>
                        </a>
                        <a class="button border-red" href="itemCategory/delete2?id=${data.id}&pid=${data.pid}">
