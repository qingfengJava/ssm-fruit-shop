...
<div class="width100 hidden_yh" style="background: #f0f0f0;padding-top: 34px;padding-bottom: 34px;">
    <div class="width1200 hidden_yh center_yh">
        ...
        <div id="vipRight">
            <div style="width: 938px; border: 1px solid #DDDDDD; background: #fff2f2;">
                <div class="width100 hidden_yh"
                     style="height: 74px; line-height: 74px; background: #f5f8fa; border-bottom: 1px solid #DDDDDD;"
                     id="navLt">
                    ...
                    <c:forEach items="${all}" var="data" varStatus="1">
                        <div class="width100 hidden_yh">
                            <div class="width100 hidden_yh font20 c_66"
                                 style="background: #faf5f5; text-indent: 47px; height: 50px; line-height: 50px; border-bottom: 1px solid #DDDDDD">
                            ...
                            <c:forEach items="${data.details}" var="chil" varStatus="1">
                                <div style="width: 838px; border-bottom: 1px dashed #DDDDDD; padding-top: 30px; padding-bottom: 30px;" class="hidden_yh center_yh">
                                    ...
                                    <div class="right_yh">
                                        <c:if test="${data.status == 3}">
                                            <a href="/itemOrder/pj?id=${chil.itemId}" class="onfff block_yh text-center font16 onHover" style="margin-top: 10px; padding-right: 6px">
                                                去评价
                                            </a>
                                        </c:if>
                                    </div>
                            ...
                            <div style="width: 838px; padding-top: 30px; padding-bottom: 30px;" class="hidden_yh center_yh tleft">
                                ...
                                <c:if test="${data.status == 0}">
                                    <a href="/itemOrder/qx?id=${data.id}" class="c_33 onHover font20 onorange right_yh" style="margin-top: 10px; padding-right: 6px">
                                        取消订单
                                    </a>
                                </c:if>
                                ...
                                <c:if test="${data.status == 2}">
                                    <a href="/itemOrder/sh?id=${data.id}" class="c_33 onHover font20 onorange right_yh" style="margin-top: 10px; padding-right: 6px">
                                        去收货
                                    </a>
                                </c:if>
                                <c:if test="${data.status == 3}">
