...
public class Item implements Serializable {
    ...
    private String url1; //主图
    private String url2; //副图1
    private String url3; //副图2
    private String url4; //副图3
    private String url5; //副图4
    ...
    private Integer categoryIdOne; //类别id一级
    private ItemCategory yiji;

    private Integer categoryIdTwo; //类别id二级
    private ItemCategory erji;

    private Integer isDelete; //是否有效，0有效 1已删除
